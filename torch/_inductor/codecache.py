...
class CompiledFxGraph:
    ...
    # stores the indirect version of the codegen "call function"
    current_callable_indirect: Optional[Callable[..., Any]]
    indirect_codegen_handle: Optional[Callable[..., Any]] = None
    ...
    def __init__(
        ...
        disabled_cudagraphs_reason: Optional[str],
        metrics_deltas: metrics.CachedMetricsDeltas,
        current_callable_indirect: Optional[Callable[..., Any]] = None,
        indirect_codegen_handle: Optional[Callable[..., Any]] = None,
    ):
        ...
        self.current_callable_indirect = current_callable_indirect
        self.indirect_codegen_handle = indirect_codegen_handle
